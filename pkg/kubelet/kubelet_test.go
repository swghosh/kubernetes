...
func newTestKubeletWithImageList(
	...
	kubelet.pleg = pleg.NewGenericPLEG(fakeRuntime, make(chan *pleg.PodLifecycleEvent, plegChannelCapacity), time.Hour, 2*time.Hour, kubelet.podCache, clock.RealClock{})
