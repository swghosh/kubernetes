...
func newTestKubeletWithImageList(
	...
	kubelet.pleg = pleg.NewGenericPLEG(fakeRuntime, make(chan *pleg.PodLifecycleEvent, 100), time.Hour, genericPlegRelistThreshold, kubelet.podCache, clock.RealClock{})
