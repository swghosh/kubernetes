...
func newTestKubeletWithImageList(
	...
	kubelet.pleg = pleg.NewGenericPLEG(fakeRuntime, make(chan *pleg.PodLifecycleEvent, plegChannelCapacity), plegRelistPeriod, plegRelistThreshold, kubelet.podCache, clock.RealClock{})
